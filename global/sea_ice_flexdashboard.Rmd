...
#difference in ice between jan 1980 and jan 2020
spatice.jan80jan20.gg <- ggplot() +
  geom_sf(data = seaice.jan1980, fill = "#3399FF", show.legend = TRUE) +
  geom_sf(data = seaice.jan2020, fill = "#9900FF", show.legend = TRUE) +
  scale_fill_manual("Sea Ice Extent", values = c("Jan 1980" = "#3399FF", "Jan 2020" = "#9900FF"))

#difference in ice between sept 1980 and sept 2020
spatice.sep80sep20.gg <- ggplot() +
  geom_sf(data = seaice.sep1980, fill = "#FF6600", show.legend = TRUE) +
  geom_sf(data = seaice.sep2020, fill = "#33CC33", show.legend = TRUE) +
  scale_fill_manual("Sea Ice Extent", values = c("Sept 1980" = "#FF6600", "Sept 2020" = "#33CC33"))

#difference in ice between jan 2020 and sept 2020
spatice.jan20sep20.gg <- ggplot() +
  geom_sf(data = seaice.jan2020, fill = "#996633", show.legend = TRUE) +
  geom_sf(data = seaice.sep2020, fill = "#FFFF00", show.legend = TRUE) +
  scale_fill_manual("Sea Ice Extent", values = c("Jan 2020" = "#996633", "Sept 2020" = "#FFFF00"))
```
...
### <b><font face="Georgia" size="6em" color="#000000">Northern Sea Ice: January 1980 - January 2020</font></b>

```{r fig.width=6, fig.height=8, echo=FALSE}
spatice.jan80jan20.gg
```

### <b><font face="Georgia" size="6em" color="#000000">Northern Sea Ice: September 1980 - September 2020</font></b>

```{r fig.width=6, fig.height=8, echo=FALSE}
spatice.sep80sep20.gg
```

### <b><font face="Georgia" size="6em" color="#000000">Northern Sea Ice: January 2020 - September 2020</font></b>

```{r fig.width=6, fig.height=8, echo=FALSE}
spatice.jan20sep20.gg
```
