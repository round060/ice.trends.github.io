...
gam_duration <- readRDS("./mn/data/lake/gam_duration.rds")
...
gam_icein <- readRDS("./mn/data/lake/gam_icein.rds")
...
gam_iceout <- readRDS("./mn/data/lake/gam_iceout.rds")
...
ggplot(data = ci_trend,
       aes(x = year_out, y = est + out_intercept)) + 
